  ...
  return (
    ...
    >
      <div className="nice-scroll w-full max-w-lg rounded-xl bg-white p-5 shadow-2xl">
        ...
        <div className="mt-5">
          <div className="mb-1.5 flex items-center gap-1.5 px-2 text-xs font-semibold tracking-wide text-slate-500">
          ...
          <textarea
            ...
            className="nice-scroll w-full resize-y rounded-lg border border-slate-200 p-3 text-sm leading-relaxed text-slate-700 outline-none transition-colors focus:border-sky-400"
